namespace Infragistics.DrawFilters
{
	...
	/// </summary>
	public class NoFocusRectDrawFilter : Win.IUIElementDrawFilter
	{
		...
		/// </summary>
		public Win.DrawPhase GetPhasesToFilter(ref Win.UIElementDrawParams drawParams)
		{
			// Indicates that we want our DrawElement method called before the focus rect is drawn.
			return Win.DrawPhase.BeforeDrawFocus;
		} 
		...
		/// </summary>
		public bool DrawElement(Win.DrawPhase drawPhase, ref Win.UIElementDrawParams drawParams)
		{
